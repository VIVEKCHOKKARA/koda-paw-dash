  ...
  return (
    <aside className="w-72 h-screen flex flex-col border-r border-border/60 bg-sidebar overflow-y-auto shrink-0">
      ...
      <div className="px-6 pt-6 pb-4 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-display text-lg font-bold text-foreground leading-none cursor-pointer" onClick={() => navigate("/")}>
            Koda
          </h1>
        ...
        <button
          onClick={toggleTheme}
          className="ml-auto p-2 rounded-xl hover:bg-muted transition-colors duration-200"
